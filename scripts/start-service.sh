...
echo -e "   Webpage:        ${GREEN}${BASE_URL}/${NC}"
echo ""
echo -e "${CYAN}🔌 API ENDPOINTS:${NC}"
echo -e "   Health Check:   ${GREEN}${BASE_URL}/api/v1/health${NC}"
echo -e "   Status:         ${GREEN}${BASE_URL}/api/v1/status${NC}"
echo ""
echo -e "${CYAN}📖 DOCUMENTATION:${NC}"
echo -e "   Swagger UI:     ${GREEN}${BASE_URL}/docs${NC}"
