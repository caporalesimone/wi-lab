...
sudo cp "$WILAB_SERVICE" /etc/systemd/system/wi-lab.service
...
echo "   sudo systemctl start wi-lab.service"
echo ""
echo "2. VERIFY SERVICE:"
echo "   sudo systemctl status wi-lab.service"
